...
try {
    ...
    throw "GBF local cache PAC server is not reachable at $PacUrl. Start either the WSL or native Windows service first."
}
...
if (-not $trusted) {
    # Windows may surface a Security Warning when a new root CA is added. Verify
    # the certificate shown is the CA generated by this local installation.
